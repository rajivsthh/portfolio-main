    ...
    return (
      <div className={`card-pro p-8 ${className}`.trim()}>
        <div className="mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-heading">Hands-on Labs</h3>
        ...
        <div className="space-y-4">
          {labs.map((lab, index) => (
            <article key={index} className="rounded-xl border border-border/50 p-4">
              <h4 className="text-sm font-semibold text-heading mb-2">{lab.title}</h4>
              ...
              <div className="flex gap-4 pt-3 border-t border-border/50">
                <a href={lab.demo} className="link-animated text-xs font-medium inline-flex items-center gap-2">
                  <ExternalLink className="w-3.5 h-3.5" />
                  Demo
                </a>
                <a href={lab.github} className="link-animated text-xs font-medium inline-flex items-center gap-2">
